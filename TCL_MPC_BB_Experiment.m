% =========================================================================
%  TCL_MPC_BB_Experiment.m
%
%  PURPOSE
%  -------
%  Runs the validated MPC servo-control experiment on the TCL Arduino board
%  using the BLACK-BOX discrete-time state-space model.
%
%  MPC SCHEME
%  ----------
...
%
%  MPC PARAMETERS  (same as TCL_MPC_BB_Simulation.m)
%    Np = 15,  Nc = 5
...
%  DEPENDENCIES
%    tclab_N.m
%    TCL_BlackBox_OE_SS.mat
%    TCL_MechModel_Parameters.mat
%    TCL_MPC_BB_SimResults_NoiseFree.mat  (for reference setpoints check)
%
%  OUTPUT
%    TCL_MPC_BB_ExpResults.mat
% =========================================================================
